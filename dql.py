...
np.random.seed(10)
net=NN()
durations, rewards,_,_,_=dql(net, 'adam', 2000, horizon, learning_step, integration_step, integration_steps_per_learning_step, pk.vect(np.pi/6, 0, 50), pk.vect(0, 0, 0), 10, lr_decay_start=4000000, eps_decay_start=4000000, eps=eps0, lr=eta0)
